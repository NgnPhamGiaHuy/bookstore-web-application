...
const generateDummyData = async () => {
    ...
    const publisherNames = [
        'Penguin Random House','HarperCollins','Simon & Schuster','Macmillan Publishers','Hachette Livre','Oxford University Press','Random House','Vintage pages','Scholastic Corporation','Pearson Education','Bloomsbury Publishing','Wiley','Pan Macmillan',
        'Harvard University Press','Cambridge University Press','McGraw Hill','Wiley','Routledge','Churchill Livingstone','Analytics Press','Glenbrook Partners','BlockchainHub Berlin','Informa Law','Pearson', 'HarperCollins Publishers','AB pages','ShadowPOET',
        'Vertical Comics','VIZ Media LLC','Puffin pages','Rick Riordan Presents','Disney Hyperion','Rick Riordan Presents','Independently published','Marysue Rucci pages','Random House Worlds','Scholastic Press','DC Comics','Image Comics','Random House Worlds','Ize Press'];
    ...
    for (let i = 0; i < 100; i++) {
        const customer = {
            ...
            customer_lastName: faker.name.lastName(),
            customer_avatar: '/img/customer/customer-default-avatar.png',
            ...
            customer_gender: faker.random.arrayElement(['male', 'female', 'other']),
            customer_birthday: faker.date.between('1960-01-01', '2005-12-31'),
            customer_nationality: faker.address.country(),
    ...
    const generateCoverImagePath = () => {
        const imageDirectory = path.join(__dirname, '../../public/img/book-cover/books');
        ...
        const relativeImagePath = '/img/book-cover/books/' + randomFileName;
